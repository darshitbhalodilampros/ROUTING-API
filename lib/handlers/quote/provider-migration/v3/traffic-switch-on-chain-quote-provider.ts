import { IOnChainQuoteProvider, log, metric, MetricLoggerUnit, OnChainQuotes } from 'lampros-sor'
import { V3Route } from 'lampros-sor/build/main/routers'
import { ChainId, Currency, CurrencyAmount } from 'lampros-core'
import { ProviderConfig } from 'lampros-sor/build/main/providers/provider'
...
export class TrafficSwitchOnChainQuoteProvider implements IOnChainQuoteProvider {
  ...
  async getQuotesManyExactIn<TRoute extends V3Route >(
  ...
  private compareQuotes<TRoute extends V3Route >(
